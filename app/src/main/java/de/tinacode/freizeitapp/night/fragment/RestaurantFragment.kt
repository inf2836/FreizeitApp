...
class RestaurantFragment: Fragment() {
    ...
    interface ActivityCallbacks {
        fun openRestaurantDetails(data: DataModel)
    }
    ...
    override fun onCreateView(
        ...
        recyclerView.adapter = RestaurantAdapter(viewmodel.list)
        return view
    }
    ...
    private inner class RestaurantHolder(view: View) :
        ...
        override fun onClick(v: View) {
            activityCallbacks?.openRestaurantDetails(data)
        }

    }

    private inner class RestaurantAdapter(var list: List<DataModel>) :
